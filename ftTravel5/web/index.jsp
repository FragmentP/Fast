    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-6 col-md-4">
          <a href="http://localhost:8080/Tour/4/frontshow">
            <div class="media">
              <div class="media-left">
                <i class="icon-uniE907"></i>
              </div>
              <div class="media-body">
                <h4 class="media-heading" style="color: #e76969">热门景点推荐</h4>
                <p style="font-size: 25px">上海迪士尼度假区</p>
              </div>
            </div>
          </a>
        </div>
        <div class="col-xs-6 col-md-4">
          <a href="http://localhost:8080/Tour/3/frontshow">
            <div class="media">
              <div class="media-left">
                <i class="icon-uniE907"></i>
              </div>
              <div class="media-body">
                <h4 class="media-heading" style="color: #02ff7c">特惠景点推荐</h4>
                <p style="font-size: 25px">浪漫哈尔滨</p>
              </div>
            </div>
          </a>
        </div>
        <div class="col-xs-6 col-md-4">
          <a href="http://localhost:8080/Tour/1/frontshow">
            <div class="media">
              <div class="media-left">
                <i class="icon-uniE907"></i>
              </div>
              <div class="media-body">
                <h4 class="media-heading" style="color: #02ff7c">特惠景点推荐</h4>
                <p style="font-size: 25px">北海道札幌</p>
              </div>
            </div>
          </a>
        </div>
