				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="tourOrderAdd"> 
				          ...
				          <div class="form-group">
				             ...
				             <span onclick="ajaxTourOrderAdd();" class="btn btn-primary bottom5 top5">提交订单</span>
				          </div>
						</form> 
...
var basePath = "<%=basePath%>";
	...
	function ajaxTourOrderAdd() { 
		...
		jQuery.ajax({
			type : "post",
			url : basePath + "TourOrder/userAdd",
			dataType : "json" , 
...
$(function(){
	...
	$.ajax({
		...
		success: function(tours,response,status) { 
    		...
    		$("#tourOrder_tourObj_tourId").val(<%=request.getParameter("tourId") %>);
    	}
	});
	//初始化订单用户下拉框值 
	$.ajax({
